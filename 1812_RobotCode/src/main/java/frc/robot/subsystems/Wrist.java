...
public class Wrist extends SubsystemBase {
  ...
  public Wrist() {
    ...
    wristPIDController.setFF(WristConstants.wristFF);
    wristPIDController.setOutputRange(WristConstants.wristOutputMin, WristConstants.wristOutputMax);

    wristMotor.burnFlash();

    desiredAngle = WristConstants.wristUpDegrees;
  }
  @Override
  ...
  public boolean atFlip()
  {
    return wristEncoder.getPosition()>50;
  }
  public boolean atPlace()
  {
    return wristEncoder.getPosition()>60;
  }
}
